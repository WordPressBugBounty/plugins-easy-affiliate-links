		...
		array(
			...
			'settings' => array(
				...
				array(
					...
					'description' => __( 'Your credential version based on region: 2.1 or 3.1 for North America, 2.2 or 3.2 for Europe, 2.3 or 3.3 for Far East.', 'easy-affiliate-links' ),
					'type' => 'text',
					'default' => '',
				),
			),
