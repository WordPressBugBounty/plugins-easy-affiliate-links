	...
	'subGroups' => array(
		array(
			...
			'settings' => array(
				...
				array(
					'id' => 'exclude_affiliate_links',
					'name' => __( 'Exclude from Regular Link Add', 'easy-affiliate-links' ),
					'description' => __( 'Prevent affiliate links from showing up when adding a regular WordPress link.', 'easy-affiliate-links' ),
					'type' => 'toggle',
					'default' => true,
				),
				array(
				...
				array(
					'id' => 'conditional_links_js',
					'name' => __( 'Update Conditional Links through JS', 'easy-affiliate-links' ),
					'description' => __( 'When enabled, conditional links will be updated through JS to avoid cache mismatches.', 'easy-affiliate-links' ),
					'required' => 'premium',
					'type' => 'toggle',
					'default' => false,
				),
